package vttp2022.paf.day22workshop.models;
...
public class RSVP {
    ...
    public static RSVP create(JsonObject jsonObject){
        ...
        r.setConfirmationDate(jsonObject.getString("confirmationDate"));
        if(r.confirmationDate.isEmpty()){
